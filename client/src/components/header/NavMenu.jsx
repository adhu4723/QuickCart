...
const NavMenu = () => {
  const navLinks = [
    ...
    },
    {
      ...
      subname: [
        ...
        { main: "Fashion", sub: ["Men", "Women", "Kids", "Footwear"] },
  ...
  return (
    <nav className="pb- h-[50px] w-full -mt-2 bg-white hidden lg:block shadow-sm ">
        ...
        <ul className="flex  space-x-6">
          {navLinks.map((link, idx) => (
            ...
            >
              ...
              {/* Dropdown */}
              {link.subname && (
                <ul className="absolute top-full left-0 mt-1 bg-white shadow-md rounded w-[400px] opacity-0 group-hover:opacity-100 invisible group-hover:visible grid grid-cols-2 gap-4 transition-all duration-300 z-50 p-4">
